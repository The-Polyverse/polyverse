...
export default function createDataProvider(store: Store): DataProvider {
  ...
  return {
    ...
    create: async <TData extends BaseRecord, TVariables>({ resource, variables }: CreateParams<TVariables>): Promise<CreateResponse<TData>> => {
      if (resource === 'messages') {
    ...
    update: async <TData extends BaseRecord, TVariables>({ resource, id, variables }: UpdateParams<TVariables>): Promise<UpdateResponse<TData>> => {
      if (resource === 'messages') {
    ...
    deleteOne: async <TData extends BaseRecord, TVariables>({ resource, id }: DeleteOneParams<TVariables>): Promise<DeleteOneResponse<TData>> => {
      if (resource === 'messages') {
    ...
    deleteMany: async <TData extends BaseRecord, TVariables>({ resource, ids }: DeleteManyParams<TVariables>): Promise<DeleteManyResponse<TData>> => {
      if (resource === 'messages') {
    ...
    getMany: async <TData extends BaseRecord>({ resource, ids }: GetManyParams): Promise<GetListResponse<TData>> => { 
      if (resource === 'messages') {
    ...
    createMany: async <TData extends BaseRecord, TVariables>({ resource, variables }: CreateManyParams<TVariables>): Promise<CreateManyResponse<TData>> => {
      if (resource === 'messages') {
    ...
    updateMany: async <TData extends BaseRecord, TVariables>({ resource, ids, variables }: UpdateManyParams<TVariables>): Promise<UpdateManyResponse<TData>> => {
      if (resource === 'messages') {
